...
%install
export SOURCE_DATE_EPOCH=1606784236
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/thermal_monitor
cp %{_builddir}/thermal_daemon-2.4/COPYING %{buildroot}/usr/share/package-licenses/thermal_monitor/b3aebbdebf056cbf1cb73b76edf8ea105c37239d
cp %{_builddir}/thermal_daemon-2.4/tools/thermal_monitor/qcustomplot/GPL.txt %{buildroot}/usr/share/package-licenses/thermal_monitor/8624bcdae55baeef00cd11d5dfcfa60f68710a02
pushd tools/thermal_monitor
%make_install
popd
